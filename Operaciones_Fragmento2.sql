...
insert into diccionario_distribucion values (2,'ConnectionFragmeto1a2','Fragmento2AW','Person','EmailPromotion'); -- Instancia 2 SQL Server
GO
...
insert into val_email_promotion values (2,'1')
insert into val_email_promotion values (2,'2')